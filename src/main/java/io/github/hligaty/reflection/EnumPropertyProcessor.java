...
public class EnumPropertyProcessor {
    ...
    public void process() throws NotFoundException, ClassNotFoundException, CannotCompileException, IOException {
        ...
        List<String> classnames = Resources.readLines(resource, StandardCharsets.UTF_8);
        ClassPool classPool = ClassPool.getDefault();
        CtClass enumPropertyCtClass = classPool.get(EnumProperty.class.getCanonicalName());
        try {
